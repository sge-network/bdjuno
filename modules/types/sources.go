...
import (
	...
	sgeapp "github.com/sge-network/sge/app"
...
func buildLocalSources(cfg *local.Details, encodingConfig *params.EncodingConfig) (*Sources, error) {
	...
	sgeApp := sgeapp.NewSgeApp(
		log.NewTMLogger(log.NewSyncWriter(os.Stdout)), source.StoreDB, nil, true, map[int64]bool{},
		cfg.Home, 0, sgeapp.MakeEncodingConfig(), simapp.EmptyAppOptions{},
	)
	...
	sources := &Sources{
		...
		MintSource:     localmintsource.NewSource(source, minttypes.QueryServer(sgeApp.MintKeeper)),
